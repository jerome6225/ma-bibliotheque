<div class="col-xs-12 col-md-10 content_page">
    ...
    <div class="col-xs-12 col-sm-9 description_book">
        ...
        <?php endif ?>
        <?php if ($hasEbook): ?>
            <div class="col-xs-offset-4 col-xs-8 col-sm-offset-0 col-sm-6 btn btn-default to_download_book">
                <a href="<?php echo $urlEbook ?>">Télécharger le livre</a>
            </div>
            <div class="row"></div>
            <div class="col-xs-offset-4 col-xs-8 col-sm-offset-0 col-sm-6 btn btn-default to_read_book">
